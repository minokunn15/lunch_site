...
var s_lastModified="2015/04/22 15:24:00"

var s_account="rcrttraining118dev"
...
s.siteID="tyoushoku"					// leftmost value in pagename
...
+"1;n<=250;n++){s.vl_t+=',prop'+n+',eVar'+n;s.vl_m+=',prop'+n+',eVar'+n}for(n=1;n<=5;n++)s.vl_t+=',hier'+n;for(n=1;n<=3;n++)s.vl_t+=',list'+n;s.va_m=s.sp(s.vl_m,',');s.vl_l2=',tnt,pe,pev1,pev2,pev3,re"
